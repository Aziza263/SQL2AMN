 ...
 * </p>
 * <ul>
 *   <li>{@link sQL2AMN.amn.impl.SetDefinitionImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SetDefinitionImpl extends MinimalEObjectImpl.Container implements SetDefinition {
	...
	protected EClass eStaticClass() {
		return AmnPackage.Literals.SET_DEFINITION;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AmnPackage.SET_DEFINITION__NAME, oldName, name));
	}
