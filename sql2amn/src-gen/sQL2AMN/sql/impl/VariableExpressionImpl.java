 ...
 * </p>
 * <ul>
 *   <li>{@link sQL2AMN.sql.impl.VariableExpressionImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class VariableExpressionImpl extends ExpressionImpl implements VariableExpression {
	...
	protected EClass eStaticClass() {
		return SqlPackage.Literals.VARIABLE_EXPRESSION;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SqlPackage.VARIABLE_EXPRESSION__NAME, oldName, name));
	}
