 ...
 * </p>
 * <ul>
 *   <li>{@link sQL2AMN.sql.impl.LiteralExpressionImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class LiteralExpressionImpl extends ExpressionImpl implements LiteralExpression {
	...
	protected EClass eStaticClass() {
		return SqlPackage.Literals.LITERAL_EXPRESSION;
	}
	...
	public void setValue(String newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SqlPackage.LITERAL_EXPRESSION__VALUE, oldValue,
					value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case SqlPackage.LITERAL_EXPRESSION__VALUE:
			return getValue();
		}
