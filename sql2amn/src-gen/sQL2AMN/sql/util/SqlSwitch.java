...
public class SqlSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case SqlPackage.CREATE_TABLE_STATEMENT: {
			...
			if (result == null)
				result = caseStatement(createTableStatement);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case SqlPackage.INSERT_STATEMENT: {
			...
			if (result == null)
				result = caseStatement(insertStatement);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case SqlPackage.SELECT_INTO_STATEMENT: {
			SelectIntoStatement selectIntoStatement = (SelectIntoStatement) theEObject;
			T result = caseSelectIntoStatement(selectIntoStatement);
			if (result == null)
				result = caseStatement(selectIntoStatement);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		...
		case SqlPackage.FOR_LOOP_STATEMENT: {
			...
			if (result == null)
				result = caseStatement(forLoopStatement);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		...
		case SqlPackage.FIELD_ACESS_EXPRESSION: {
			FieldAcessExpression fieldAcessExpression = (FieldAcessExpression) theEObject;
			T result = caseFieldAcessExpression(fieldAcessExpression);
			if (result == null)
				result = caseExpression(fieldAcessExpression);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Select Into Statement</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Select Into Statement</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseSelectIntoStatement(SelectIntoStatement object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Field Acess Expression</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Field Acess Expression</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseFieldAcessExpression(FieldAcessExpression object) {
		return null;
	}
